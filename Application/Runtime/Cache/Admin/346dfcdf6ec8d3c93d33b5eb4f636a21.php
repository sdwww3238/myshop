            ...
            <form action="<?php echo U('addOk');?>" method="post" enctype="multipart/form-data">
                <table border="1" width="100%" class="table_a" id="general-tab-tb">
                    ...
                    <script type="text/javascript">
                        var select_num=1;
                        function add_sel(obj) {
                            var fu_sel=$('#cat_id_0').clone();
                            fu_sel.attr('id','cat_id'+select_num);
                            fu_sel.attr('name','cat_ext_info[]');
                                $(obj).after(fu_sel);
                            select_num++;
                        }
                    </script>
                    ...
                    <td>
                        ...
                        <div id="goods_logo_dv">
                            <img src="" alt="" id="goods_logo_im" width="160" height="160" />
                        </div>
                    </td>
                </tr>
                </table>
                ...
                <table border="1" width="100%" class="table_a" id="detail-tab-tb" style="display:none;">
                    <tr>
                        ...
                        <td>
                            <script name='goods_introduce' type="text/plain" id="myEditor" style="width:666px;height:240px;">
                            </script>
                        </td>
                    </tr>
                    <script type='text/javascript'>
                ...
                >
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="goods_logo_dv_0">
                                <img src="" alt="" id="goods_logo_im_0" width="160" height="160"/>
                            </div>
                        </td>
                    </tr>
                ...
                <script type="text/javascript">
                    $(function(){
                        new uploadPreview({ UpBtn: "goods_pics_0", DivShow: "goods_logo_dv_0", ImgShow: "goods_logo_im_0" });
                    })
                </script>
                <table width="100%">
                    <tr>
